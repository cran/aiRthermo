...
function(Ptop,P0,T0,w0,deltaP){
  ...
  theta_lcl=0
  gotIT=0
  outvals<-.C("find_lcl_Rworld",as.double(Ptop),as.double(P0),as.double(T0),
                                as.double(w0),as.double(plcl),
                                as.double(tlcl),as.double(wlcl),
                                as.double(theta_lcl),
                                as.double(deltaP),as.integer(gotIT))
              
              names(outvals)<-c( "Ptop", "p","t","w","plcl","tlcl","wlcl",
                                 "theta_lcl","deltaP","gotIT")
